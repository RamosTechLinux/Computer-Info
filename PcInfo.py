#!/usr/bin/env python3
# Script: Computer Info V1
# Author: Gabriel Ramos
# Website: https://website-gabriel.netlify.app/
...
print()
print(f"\n\n{YELLOW}             ⚙️   Computer Info   ⚙️")
print(f"{RED}                [ Code By Ramos ]         \n")
#ASCII ART
print("""
   ___                     _             ___       __     
  / __|___ _ __  _ __ _  _| |_ ___ _ _  |_ _|_ _  / _|___ 
 | (__/ _ \ '  \| '_ \ || |  _/ -_) '_|  | || ' \|  _/ _ \\
  \___\___/_|_|_| .__/\_,_|\__\___|_|   |___|_||_|_| \___/
                |_|                                        Versão V1
...
print(f"{GREEN}    🛡️ Kernel:{LIGHT_CYAN} {kernel}")
print(f"{GREEN}    ⏰ Uptime:{LIGHT_CYAN} {uptime}")
print(f"{GREEN}    📦 Packages:{LIGHT_CYAN} {packages}")
print(f"{GREEN}    🖥️ Desktop:{LIGHT_CYAN} {de}")
print(f"{GREEN}    🖼️ Window Manager:{LIGHT_CYAN} {wm}")
...
print(f"{GREEN}    ⚡️CPU:{LIGHT_CYAN} {cpu}")
